...
- **Remotos**: `github` (Vampsecure-Labs/vamp-shodan-hunt) y `forgejo` (vampsecure/vamp-shodan-hunt). Nunca `origin`.
...
- La clave API Shodan se pasa por `--key` o variable `SHODAN_API_KEY` — nunca hardcodeada.
